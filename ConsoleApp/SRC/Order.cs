...
namespace OptimaliserenPracticum
{
	...
	public class Order
	{
		...
		// Constructor
		public Order(int orderNumber, string placeName, int frequency, int containerCount, int volumePerContainer, int emptyingTime, int matrixID, int xCoordinate, int yCoordinate)
		{
