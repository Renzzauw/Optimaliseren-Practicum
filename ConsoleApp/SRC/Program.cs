...
namespace OptimaliserenPracticum
{
	...
	public class SimulatedAnnealing
	{
		...
		public void Run(State initialState)
		{
            ...
            FileHandler.SaveState(DTS.bestStatus);
            FileHandler.Print(DTS.bestStatus);
            Console.WriteLine("time : " + DTS.GetAllEval(DTS.bestEvals));
            Console.WriteLine("orders : " + DTS.bestOrderScore);
